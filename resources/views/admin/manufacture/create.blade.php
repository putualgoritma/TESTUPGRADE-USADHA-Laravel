...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.manufacture.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card tampil">
                ...
                <div class="card-body">
                    <table class="table" id="products_table">
                        ...
                        <tbody>
                            @foreach (old('manufactures', ['']) as $index => $oldProduct)
                                <tr id="product{{ $index }}">
                                    <td>
                            ...
                            @endforeach
                            <tr id="product{{ count(old('manufactures', [''])) }}"></tr>
                        </tbody>
                    </table>
...
<script>
  ...
  $(document).ready(function(){
    let row_number = {{ count(old('manufactures', [''])) }};
